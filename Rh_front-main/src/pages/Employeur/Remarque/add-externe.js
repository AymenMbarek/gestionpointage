...
//    { title: "Remarque", field: 'remarque' },
    ...
    useEffect(() => {
        ...
        console.log("props remarque",props.getPersonnes())
                                ...
                                <CardBody>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className="form-horizontal clearfix">
                                            <CardTitle className="h4">Remarque Personne Externe</CardTitle>
                                            <hr/>
                                            <Form>
                                                <div className="row">
