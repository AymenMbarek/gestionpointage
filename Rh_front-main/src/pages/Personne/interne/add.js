...
import {
    Button,
    Label, NavItem, NavLink, TabContent, InputGroup, TabPane, Input, Card, CardBody,CardTitle,
    Col, Row, FormGroup
} from "reactstrap"

import classnames from "classnames"
import Switch from "react-switch"
import {getQualifications, addNewPersonne} from "../../../store/actions"
...
const NewPersonne = props =>{
   //add
   const handleValidSubmitNewPersonne = () => {
    console.log("personne values",form)
    props.addNewPersonne(form,form.type='I') 
...
/* end useffect */
  ...
  const [form, setForm] = useState({genre:"Homme"})   
       ...
       setForm((prevState) => ({
        ...prevState,
          image: result.toString(),
             ...
             console.log("form after select image", form);
      })
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Ajout Personne Interne</title>
        </MetaTags>
        <div className="container-fluid">
          <Breadcrumbs maintitle="Administration" title="Personne" breadcrumbItem="Ajout Personne Interne" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                    <CardTitle className="h4"><h4><center>Ajout un personne Interne </center></h4></CardTitle>
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-5">
                              <div className="mb-3">
                                    ...
                                    <select name='profile' className="form-select" onChange={val=>setForm((prevState) => ({
                                  ...prevState,
...
<br/><br/>
                          ...
                          <hr/>
                            ...
                            <div className="col-lg-4">
                              <div className="mb-3" >
                                <Label className="form-label" htmlFor="numeroMaison"  >  Numéro  </Label>
                          ...
                          <Row>
                            ...
                            <Col sm={3}>
                            <div className="mb-3" >
                              <Label className="form-label" htmlFor="taux"  > Taux / heure </Label>
                                <Input id="manufacturername"   onChange={val=>setForm((prevState) => ({
                                    ...prevState,
                                    taux: val.target.value,
                                }))} type="text" disabled={true} className="form-control"  />
                          ...
                          <Col sm={3}>
                          <div className="mb-3">
                                  <Label htmlFor="heuresMax">Heures Max / mois</Label>
                                   <Input type="text" name='heuresMax' id="heuresMax"
                                   onChange={val=>setForm((prevState) => ({
                                    ...prevState,
                              ...
                              <Col sm={3}>
                                  <div className="mb-3">
                                      <Label htmlFor="heuresMax">HS Max / mois</Label>
                                      <Input type="text" name='heuresMax' id="heuresMax"
                                             />
                          ...
                          <Col sm={4}>
                           ...
                           <Row>
                            ...
                            <Col sm={3}>
                              <div className="mb-3">
                                    <Label className="form-label" htmlFor="validiteFormationSecurite" > Validité </Label>
                                    <Input type="date" name='validiteFormationSecurite'  id="example-date-input" onChange={val=>setForm((prevState) => ({
                                  ...prevState,
                          ...
                          <Col sm={6}>
                            ...
                            <Button onClick={()=>handleValidSubmitNewPersonne()} color="success" id="sa-success" type="button" className="waves-effect waves-light me-1">
...
NewPersonne.propTypes = {
  
  getQualifications: PropTypes.func,
  addNewPersonne: PropTypes.func,
}
...
const mapDispatchToProps = (dispatch) => ({
  ...
  addNewPersonne: (personne) => dispatch(addNewPersonne(personne)),

});

export default connect(mapStatetoProps, mapDispatchToProps)(NewPersonne)
// Just some styles
const styles = {
  container: {
    display: "flex",
