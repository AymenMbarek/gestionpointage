 ...
 */
class getObjetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjetRepository' shared autowired service.
     *
     * @return \App\Repository\ObjetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjetRepository.php';

        return $container->privates['App\\Repository\\ObjetRepository'] = new \App\Repository\ObjetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
