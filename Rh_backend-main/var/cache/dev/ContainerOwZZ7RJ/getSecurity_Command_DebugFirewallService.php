...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.PYF1pPc'] ?? $container->get_ServiceLocator_PYF1pPcService()), ($container->privates['.service_locator._XnDFkD'] ?? $container->load('get_ServiceLocator_XnDFkDService')), ['login' => [0 => ($container->privates['security.authenticator.json_login.login'] ?? $container->load('getSecurity_Authenticator_JsonLogin_LoginService'))], 'api' => [0 => ($container->privates['security.authenticator.jwt.api'] ?? $container->load('getSecurity_Authenticator_Jwt_ApiService'))], 'app' => [0 => ($container->privates['security.authenticator.guard.app.0'] ?? $container->load('getSecurity_Authenticator_Guard_App_0Service'))]], true);
