 ...
 */
class getPointageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PointageRepository' shared autowired service.
     *
     * @return \App\Repository\PointageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PointageRepository.php';

        return $container->privates['App\\Repository\\PointageRepository'] = new \App\Repository\PointageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
