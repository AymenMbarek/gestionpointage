 ...
 */
class getHolidayRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HolidayRepository' shared autowired service.
     *
     * @return \App\Repository\HolidayRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HolidayRepository.php';

        return $container->privates['App\\Repository\\HolidayRepository'] = new \App\Repository\HolidayRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
