 ...
 */
class getListActiviteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ListActiviteRepository' shared autowired service.
     *
     * @return \App\Repository\ListActiviteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ListActiviteRepository.php';

        return $container->privates['App\\Repository\\ListActiviteRepository'] = new \App\Repository\ListActiviteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
