 ...
 */
class getObjetRemisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjetRemisRepository' shared autowired service.
     *
     * @return \App\Repository\ObjetRemisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjetRemisRepository.php';

        return $container->privates['App\\Repository\\ObjetRemisRepository'] = new \App\Repository\ObjetRemisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
