...
class Activity extends \App\Entity\Activity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Activity' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Activity' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Activity' . "\0" . 'groupe'];
        }
     ...
     * {@inheritDoc}
     */
    public function setGroupe(?\App\Entity\Groupe $groupe): \App\Entity\Activity
    {
