 ...
 */
class getSmartphoneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SmartphoneRepository' shared autowired service.
     *
     * @return \App\Repository\SmartphoneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SmartphoneRepository.php';

        return $container->privates['App\\Repository\\SmartphoneRepository'] = new \App\Repository\SmartphoneRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
