 ...
 */
class getQualificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QualificationRepository' shared autowired service.
     *
     * @return \App\Repository\QualificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QualificationRepository.php';

        return $container->privates['App\\Repository\\QualificationRepository'] = new \App\Repository\QualificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
