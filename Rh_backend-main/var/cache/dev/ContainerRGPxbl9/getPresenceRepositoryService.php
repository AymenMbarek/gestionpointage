 ...
 */
class getPresenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PresenceRepository' shared autowired service.
     *
     * @return \App\Repository\PresenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PresenceRepository.php';

        return $container->privates['App\\Repository\\PresenceRepository'] = new \App\Repository\PresenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
