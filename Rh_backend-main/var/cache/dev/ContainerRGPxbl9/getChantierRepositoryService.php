 ...
 */
class getChantierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChantierRepository' shared autowired service.
     *
     * @return \App\Repository\ChantierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChantierRepository.php';

        return $container->privates['App\\Repository\\ChantierRepository'] = new \App\Repository\ChantierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
