 ...
 */
class getRemarqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RemarqueRepository' shared autowired service.
     *
     * @return \App\Repository\RemarqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RemarqueRepository.php';

        return $container->privates['App\\Repository\\RemarqueRepository'] = new \App\Repository\RemarqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
