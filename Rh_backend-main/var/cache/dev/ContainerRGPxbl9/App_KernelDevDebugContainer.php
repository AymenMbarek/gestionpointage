...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AppmobileController' => 'getAppmobileControllerService',
            ...
            'App\\Controller\\PointageController' => 'getPointageControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Serializer'.\DIRECTORY_SEPARATOR.'MediaObjectNormalizer.php';
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \App\Serializer\MediaObjectNormalizer(($this->privates['vich_uploader.storage.file_system'] ?? $this->getVichUploader_Storage_FileSystemService())), 2 => $e, 3 => $k, 4 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $m), 5 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $m, ['enable_max_depth' => true]), 6 => $k, 7 => $e, 8 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $n, NULL, $l, $j, $m), 9 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $o, $l), 10 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($l, true, ['enable_max_depth' => true]), 11 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true, ['enable_max_depth' => true]), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, ['enable_max_depth' => true]), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(['enable_max_depth' => true]), 14 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $o, $n, $p, $a, $m, $q, [], new RewindableGenerator(function () {
            ...
            return new \EmptyIterator();
        }, 0), $f, $r), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(['enable_max_depth' => true]), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $m), 18 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($q, $m, $b, $s, NULL, [])), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(['enable_max_depth' => true]), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 24 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, ['enable_max_depth' => true]), 25 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($p, $n, $o, ['enable_max_depth' => true]), 'page', 'pagination', $f, $a), $f, $n, $i), 26 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 27 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($t, $o, $p), 28 => $t], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(['enable_max_depth' => true]), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, ['enable_max_depth' => true]), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(['enable_max_depth' => true]), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        ]), [0 => 'vich_uploader.listener.clean.media_object', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => 'vich_uploader.listener.remove.media_object', 5 => 'vich_uploader.listener.upload.media_object', 6 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\HolidayRepository' => ['privates', 'App\\Repository\\HolidayRepository', 'getHolidayRepositoryService', true],
            'App\\Repository\\ListActiviteRepository' => ['privates', 'App\\Repository\\ListActiviteRepository', 'getListActiviteRepositoryService', true],
            'App\\Repository\\MediaObjectRepository' => ['privates', 'App\\Repository\\MediaObjectRepository', 'getMediaObjectRepositoryService', true],
            'App\\Repository\\ObjetRemisRepository' => ['privates', 'App\\Repository\\ObjetRemisRepository', 'getObjetRemisRepositoryService', true],
            'App\\Repository\\ObjetRepository' => ['privates', 'App\\Repository\\ObjetRepository', 'getObjetRepositoryService', true],
            ...
            'App\\Repository\\PointageRepository' => ['privates', 'App\\Repository\\PointageRepository', 'getPointageRepositoryService', true],
            'App\\Repository\\PresenceRepository' => ['privates', 'App\\Repository\\PresenceRepository', 'getPresenceRepositoryService', true],
            'App\\Repository\\PrestationRepository' => ['privates', 'App\\Repository\\PrestationRepository', 'getPrestationRepositoryService', true],
            'App\\Repository\\QualificationRepository' => ['privates', 'App\\Repository\\QualificationRepository', 'getQualificationRepositoryService', true],
            'App\\Repository\\RemarqueRepository' => ['privates', 'App\\Repository\\RemarqueRepository', 'getRemarqueRepositoryService', true],
            'App\\Repository\\SmartphoneRepository' => ['privates', 'App\\Repository\\SmartphoneRepository', 'getSmartphoneRepositoryService', true],
            ...
            'App\\Repository\\ListActiviteRepository' => '?',
            'App\\Repository\\MediaObjectRepository' => '?',
            'App\\Repository\\ObjetRemisRepository' => '?',
            'App\\Repository\\ObjetRepository' => '?',
            ...
            'App\\Repository\\PresenceRepository' => '?',
            'App\\Repository\\PrestationRepository' => '?',
            'App\\Repository\\QualificationRepository' => '?',
            'App\\Repository\\RemarqueRepository' => '?',
            'App\\Repository\\SmartphoneRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.PYF1pPc' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_PYF1pPcService()
    {
        return $this->privates['.service_locator.PYF1pPc'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RBJS30pZvw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KubE7vQigQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4ipVz-Jrur', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YBOc74gffa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7YfctfTokU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ksRdovVU+c', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b4cBiErWVQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.PYF1pPc'] ?? $this->get_ServiceLocator_PYF1pPcService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.app' => ($this->privates['.security.request_matcher.ZBwe1io'] ?? ($this->privates['.security.request_matcher.ZBwe1io'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/application/api')));
        }, 3));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'ASSIST Rh',
            'api_platform.description' => 'A rest API to manage a backend project.',
            ...
            'lexik_jwt_authentication.token_ttl' => 3600000000,
